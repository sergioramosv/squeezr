...
async function installZest() {
  ...
  const GGUF_URL = 'https://huggingface.co/sergioramosv/zest-0.5b/resolve/main/zest-0.5b-Q4_K_M.gguf'
  ...
  if (modelExists) {
    ...
    if (!fs.existsSync(GGUF_PATH)) {
      ...
      await new Promise((resolve, reject) => {
        ...
        console.log('  The model will be available at https://huggingface.co/sergioramosv/zest-0.5b')
